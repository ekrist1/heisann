                    ...
                    <div class="w-full max-w-lg mx-auto mt-4" v-if="!loading">
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full px-3 mb-6 md:mb-0">
                                ...
                                <input class="appearance-none block w-full bg-white text-grey-darker border border-grey rounded py-3 px-4 mb-3" id="grid-to" type="email" placeholder="skriv inn din e-post adresse" v-model="form.emailfrom">
                            ...
                            <div class="w-full px-3">
                                ...
                                <input class="appearance-none block w-full bg-white text-grey-darker border border-grey rounded py-3 px-4 mb-3" id="grid-to" type="text" placeholder="firma eller navn" v-model="form.from">
                                <span class="text-red-dark text-sm" v-if="form.errors.has('from')">Feil format.</span>
                            </div>
                            ...
                            <div class="w-full px-3">
                                ...
                                <div class="relative">
                                    <select name="emailfrom" class="block appearance-none w-full bg-white border border-grey text-grey-darker py-3 px-4 pr-8 rounded" v-model="form.group">
                                    ...
                                    <span class="text-red-dark text-sm" v-if="form.errors.has('emailto')">Du må velge en avsender</span>
                                </div>
                            </div>
                        </div>
