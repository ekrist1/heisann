...
@section('content')
    ...
    <group-form :group="{{ $group }}" :users="{{ $users }}" method="patch" action="/dashboard/group/{{ $group->id }}" inline-template>
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <form class="w-full m-6">
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                    <h2 class="mb-6">Oppdater gruppe</h2>
                    ...
                    <input class="is-input-full bg-white text-grey-darker"
                           id="name" type="text" placeholder="Navn på gruppen" v-model="form.name" name="name">
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <input class="is-input-full bg-white text-grey-darker"
                           id="email" type="text" placeholder="E-post til gruppen" v-model="form.email" name="email">
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <textarea class="is-input-full bg-white text-grey-darker h-16"
                              id="description" type="text" placeholder="Beskrivelse" v-model="form.description" name="description"></textarea>
                ...
                <div class="flex">
                    <div class="px-4 py-2">
                        <button class="bg-indigo-dark hover:bg-indigo text-white font-bold py-2 px-4 inline-flex items-center justify-center" @click.prevent="submit">
