...
@section('content')
    ...
    <div class="w-full max-w-lg mx-auto mt-4">
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <form method="POST" action="{{ action('Tenant\UserManagerController@update', ['id' => $user->id]) }}" class="w-full m-6">
                @csrf
                @method('PATCH')
                <div class="w-full px-3 mb-6 md:mb-0">
                    <h2 class="text-center mb-6">Oppdater bruker</h2>
                    ...
                    <input class="is-input-full bg-white text-grey-darker"
                           id="name" type="text" placeholder="Navn på bruker" name="name" value="{{ old('name', $user->name) }}">
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <input class="is-input-full bg-white text-grey-darker"
                           id="email" type="text" placeholder="E-post" name="email" value="{{ old('email', $user->email)}}">
                ...
                <div class="w-full px-3 mb-6 md:mb-0">
                    ...
                    <input class="is-input-full bg-white text-grey-darker"
                           id="email" type="text" placeholder="Mobilnummer" name="mobile" value="{{ old('mobile', $user->phone)}}">
