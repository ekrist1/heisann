        ...
        <div class="bg-teal-lightest border-t-4 border-teal rounded-b text-teal-darkest px-4 py-3 shadow-md mt-6 mb-6" role="alert">
            <div class="flex">
                ...
                <div>
                    ...
                    <p class="text-sm">Alle priser er eksklusive transaksjonsgebyr(25%). Du fyller på saldo for sending og mottak av meldinger. Saldo som ikke har hatt bevegelse
